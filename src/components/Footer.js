...
export default class Footer extends React.Component {
  render() {
          ...
          <div className="pb-8 xl:grid xl:grid-cols-5 xl:gap-8">
            <div className="grid grid-cols-2 gap-8 xl:col-span-4">
              <div className="md:grid md:grid-cols-2 md:gap-8">
                {_.map(footerSections.slice(0, 2), (section, sectionIdx) => {
              ...
              <div className="md:grid md:grid-cols-2 md:gap-8">
                {_.map(footerSections.slice(2), (section, sectionIdx) => {
                  const sectionType = _.get(section, 'type');
                  const component = _.upperFirst(_.camelCase(sectionType));
                  if (!component) {
                      throw new Error(`footer section does not have the 'type' property`);
    ...
    return (
      <footer id="colophon" className="bg-white dark:bg-gray-900">
