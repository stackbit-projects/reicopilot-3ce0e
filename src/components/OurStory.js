...
const OurStory = () => (
  <div className="mt-6 prose prose-primary prose-lg text-gray-500 dark:text-gray-300 mx-auto">
    <p>
      Faucibus commodo massa rhoncus, volutpat. <strong className="!text-primary-500">Dignissim</strong> sed
      <strong className="!text-primary-500">eget risus enim</strong>.
